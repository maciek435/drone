"""
test_htors_calibration_640x480.py

Test 4: dokladnosc i granice proxy dystansu h_tors, rozdzielczosc 640x480.
...
Zapisuje dane do htors_calibration_640x480.csv (z odchyleniem std -
to ono pokazuje GDZIE zaczyna sie degradacja pomiaru).

Uzycie:
    python3 test_htors_calibration_640x480.py
"""
